...
public class CommonBackgroundButton extends Button {
    ...
    public void refreshBackground() {
        if (fillMode == CommonBackgroundDrawable.FILL_MODE_SOLID) {
            /**
             * 0 disabled
             * 1 normal
             * 2 pressed
            ...
            mStateList.addState(new int[]{android.R.attr.state_pressed, android.R.attr
                    .state_enabled}, drawables[2]);
            // View.ENABLED_FOCUSED_STATE_SET
            mStateList.addState(new int[]{android.R.attr.state_enabled, android.R.attr
                    .state_focused}, drawables[1]);
            ...
            CommonBackgroundDrawable drawable = new CommonBackgroundDrawable();
